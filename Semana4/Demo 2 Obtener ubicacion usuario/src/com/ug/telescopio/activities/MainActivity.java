...
public class MainActivity extends FragmentActivity
	...
	public void updateLocation() {
		if (locationClient.isConnected()) {
	        ...
	        PlacesFragment fragmento = (PlacesFragment) getSupportFragmentManager().findFragmentById(R.id.fragmentMap);
	        fragmento.Posicion= new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude());
	        fragmento.reloadpMap();
		}
	}
}
